...
public class CarrotTool extends FarmingTool {
    public CarrotTool(Material material, int amount, String name, List<String> lore, List<ItemFlag> itemFlags, Map<Enchantment, Integer> enchantmentLevels, int durability, boolean unbreakable) {
        super(
            Material.GOLDEN_HOE,
            1,
